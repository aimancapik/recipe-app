          ...
          <div className="flex gap-2 flex-wrap">
            {[
              ...
              <button
                ...
                className={`flex h-11 px-5 items-center justify-center rounded-full border text-sm cursor-pointer transition-colors ${
              ...
              return (
                ...
                >
                  <span className={`material-symbols-outlined text-xl ${
                    isSelected ? 'text-primary' : 'text-[#181711]/20'
                  }`}>
                    {isSelected ? 'check_box' : 'check_box_outline_blank'}
                  </span>
                  <span className={`text-sm text-[#181711] dark:text-white ${
          ...
          <div className="flex bg-background-light dark:bg-primary/5 p-1 rounded-xl">
            {(['Easy', 'Medium', 'Hard'] as Difficulty[]).map(level => (
              <button
                ...
                className={`flex-1 py-3 px-2 rounded-lg text-sm transition-colors ${
