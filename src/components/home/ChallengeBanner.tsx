            ...
            <div className="p-4 flex items-center justify-between gap-3">
                <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5 mb-1">
                        ...
                        <span className="text-[10px] bg-white/20 text-primary-content px-2 py-0.5 rounded-full font-bold">{daysLeft}d left</span>
                    </div>
                ...
                <button
                    ...
                    className={`flex-shrink-0 px-4 py-2 rounded-xl text-xs font-black transition-all ${
                        hasJoined
                            ? 'bg-white/20 text-primary-content cursor-default'
                            : 'bg-white text-primary shadow-md active:scale-95'
                    }`}
                >
